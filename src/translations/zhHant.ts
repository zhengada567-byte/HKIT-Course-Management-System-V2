export const zhHant = {
  ...
  classroomDateInspectStep: "3. 按日期檢視教室",
  classroomDateInspectStepHint:
    "選擇日期後可查看當天所有課程（不限 Programme），方便檢查空餘教室、已佔用時段，以及當日撞堂。",
  classroomDateInspectDate: "日期",
  classroomDateInspectLoad: "檢視該日",
  classroomDateInspectSelectDate: "請先選擇日期。",
  classroomDateInspectFailed: "按日期檢視教室失敗。",
  classroomDateInspectEmpty: "選擇日期後按「檢視該日」，載入當天課表與教室空餘情況。",
  classroomDateInspectSummary:
    "{date}（{weekday}）：{sessions} 節課 · 全日空餘 {freeRooms}/{rooms} 間教室 · {conflicts} 項撞堂。",
  classroomDateInspectSessionsTitle: "當日全部課程",
  classroomDateInspectRoomsTitle: "教室空餘情況",
  classroomDateInspectConflictsTitle: "當日教室撞堂",
  classroomDateInspectNoSessions: "該日沒有課程。",
  classroomDateInspectNoRooms: "目前篩選下沒有可顯示的教室。",
  classroomDateInspectNoConflicts: "該日沒有教室撞堂。",
  classroomDateInspectFreeOnly: "只看全日空餘教室",
  classroomDateInspectTime: "時間",
  classroomDateInspectRoomSize: "容量",
  classroomDateInspectRoomType: "類型",
  classroomDateInspectRoomStatus: "狀態",
  classroomDateInspectFullyFree: "全日空餘",
  classroomDateInspectOccupied: "有課",
  classroomDateInspectOccupiedWindows: "已佔用時段",
  classroomWeeklyConflictStep: "4. 衝突教室列表",
  classroomWeeklyConflictStepHint:
    "按上課日期偵測所選學年／學期是否同一教室撞堂（忽略 Online／TBC）。僅同一天時段重疊才算衝突；同一已知老師任教不計為教室衝突。",
