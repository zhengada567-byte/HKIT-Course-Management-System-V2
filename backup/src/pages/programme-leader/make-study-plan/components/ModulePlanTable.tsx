 ...
 *
 * moduleCode + programmeCode + programmeStream + term
 *
 * Do not rely on moduleCode only.
 * Example:
 * Project Feb and Project Sep may share the same module code,
 * but they are different module instances.
 */
function getModuleIdentityKey(module: StudyPlanModule, index: number) {
  const term = module.moduleTerm || module.moduleTermPattern || "";
